...
def test_fixture(data):
    test1 =  data["create"] == "CREATE TABLE fish (name TEXT, species TEXT, tank_number INTEGER)"
    test2 =  data["insert1"] == "INSERT INTO fish VALUES ('Sammy', 'shark', 1)"
    test3 =  data["insert2"] == "INSERT INTO fish VALUES ('Jamie', 'cuttlefish', 7)"
